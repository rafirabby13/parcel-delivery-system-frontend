      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="border-t border-primary-foreground/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div>
              <h4 className="text-primary-foreground font-semibold mb-4">Download Our App</h4>
              <div className="flex gap-3">
                <a href="#" className="bg-primary-foreground text-primary px-4 py-2 rounded-lg font-medium hover:bg-primary-foreground/90 transition-colors">
                  Google Play
                </a>
                <a href="#" className="bg-primary-foreground text-primary px-4 py-2 rounded-lg font-medium hover:bg-primary-foreground/90 transition-colors">
                  App Store
        ...
        <div className="border-t border-primary-foreground/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          <p className="text-primary-foreground/70">{copyright}</p>
