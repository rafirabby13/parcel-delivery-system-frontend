...
import { useGetAllParcelByIdQuery, useUpdateParcelStatusMutation } from "@/redux/feature/parcel/parcel.api"
                ...
                <TableBody>
                    {parcels?.data?.map((item: any) => (
                        <TableRow key={item._id}>
                            ...
                            <TableCell className="flex items-center gap-2 bg-emerald-50">
                                <Select
